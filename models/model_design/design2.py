...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.vit = ViT(image_size=8, image_patch_size=1, frames=8, frame_patch_size=1, num_classes=2, dim=256,
                       depth=4, heads=16, mlp_dim=512, pool = 'cls', channels = 256, dim_head = 16,

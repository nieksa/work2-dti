...
"""
Triplet Attention是一种新颖的注意力机制，它通过捕获跨维度交互，利用三分支结构来计算注意力权重。
对于输入张量，Triplet Attention通过旋转操作建立维度间的依赖关系，随后通过残差变换对信道和空间信息进行编码
实现了几乎不增加计算成本的情况下，有效增强视觉表征的能力。
"""
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.ta1 = TripletAttention(no_spatial=False)
        self.ta2 = TripletAttention(no_spatial=False)
        self.ta3 = TripletAttention(no_spatial=False)

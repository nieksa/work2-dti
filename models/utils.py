...
def create_model(model_name):
    if model_name == 'ResNet18':
        model = generate_resnet(18, n_input_channels=6, n_classes=2)
    elif model_name == 'ResNet50':
        model = generate_resnet(50, n_input_channels=6, n_classes=2)
    ...
    #     model = C3D(num_classes=2)
        ...
        model = DenseNet(num_init_features=64,
                         ...
                         n_input_channels=6, num_classes=2)
        ...
        model = resnet_with_mil(18, n_input_channels=6, n_classes=2)
    else:
